...
This note is the local reference for `hack-through-testing` when you need to inspect or adjust the snapshot helper.
...
- If the helper changes its output locations, keep the log template and agent prompt in sync.
